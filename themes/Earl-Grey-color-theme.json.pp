#lang pollen
{
	...
	"colors": {
		...
		"activityBar.foreground": "◊(eg-color 'bg)",
		"activityBar.background": "◊(eg-color 'fg2)",
		"activityBar.dropBorder": "◊(eg-color 'bg2)",
		...
		// TODO: revisit selections and search highlights, again
		...
		"editor.findMatchBackground": "◊(eg-color 'purple2)01",
		"editor.findMatchBorder": "◊(eg-color 'purple6)66",
		"editor.findMatchHighlightBackground": "◊(eg-color 'blue4)33",
		"editor.findRangeHighlightBackground": "◊(eg-color 'teal4)22",
		"editor.rangeHighlightBackground": "◊(eg-color 'purple2)33",
		"editor.rangeHighlightBorder": "◊(eg-color 'purple6)33",
		"editor.hoverHighlightBackground": "◊(eg-color 'purple4)33",
		"editor.wordHighlightBackground": "◊(eg-color 'purple3)33",
		"editor.wordHighlightBorder": "◊(eg-color 'purple3)33",
		"editor.wordHighlightStrongBackground": "◊(eg-color 'purple3)33",
		"editor.wordHighlightStrongBorder": "◊(eg-color 'purple3)",
		"editor.lineHighlightBorder": "◊(eg-color 'grey4)33",
		"searchEditor.findMatchBackground": "◊(eg-color 'teal1)",
		"searchEditor.findMatchBorder": "◊(eg-color 'teal6)33",
		"searchEditor.textInputBorder": "◊(eg-color 'teal7)",
